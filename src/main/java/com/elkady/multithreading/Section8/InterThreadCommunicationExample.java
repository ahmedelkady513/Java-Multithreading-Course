package com.elkady.multithreading.Section8;
...
public class InterThreadCommunicationExample {
        ...
        private static final String INPUT_FILE = "D:/Java Multithreading Coruse/src/main/resources/output.txt";
        private static final String OUTPUT_FILE = "D:/Java Multithreading Coruse/src/main/resources/output_results.txt";

        private static final int N = 10;

        public static void main(String[] args) throws IOException {
            MatricesMultiplierConsumer.ThreadSafeQueue threadSafeQueue = new MatricesMultiplierConsumer.ThreadSafeQueue();
            File inputFile = new File(INPUT_FILE);
            File outputFile = new File(OUTPUT_FILE);

            MatricesMultiplierConsumer.MatricesReaderProducer matricesReader = new MatricesMultiplierConsumer.MatricesReaderProducer(new FileReader(inputFile), threadSafeQueue);
    ...
    public class GeneratorClass {
        private static final String OUTPUT_FILE = "D:/Java Multithreading Coruse/src/main/resources/output.txt";
        private static final int N = 10;
